...
public interface IServerUsingByteSerializationWithoutStrategies<TMessage> :
...
#pragma warning restore
{
    ...
    public IServerUsingByteSerializationFinalizer<TMessage> WithSerializationStrategies([DisallowNull] IEnumerable<KeyValuePair<Type, ISerializationDeserializationStrategy<Byte[]>>> strategies);
}